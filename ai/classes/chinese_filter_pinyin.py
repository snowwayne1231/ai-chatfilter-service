...
static_should_be_blocked_list = ['公众号', 'wx', 'wx小成序', '微信', '禾呈序', '程序', '小程序', '陈序', '层序', '屏音', '拼瑛', '拼音', '全部平', '文字拚', '拼鹰', '拚文字', '拚字', '字拚', '姘写', '泉饼', '关注', '公眾号', '小禾呈', '工從號', '公號', '拼', '拚', '微', '看威', '是钻', '松众號', '众号', '拚英', '是葳', '么丛', '么纵', '肿浩', '小浧', '丛号', '纵号', '涅序', '屏字', '么众', '讧纵', '字音']
